...
class Sabitler {
  ...
  static final TextStyle baslikStyle = GoogleFonts.questrial(
      fontSize: 24, fontWeight: FontWeight.w900, color: anaRenk);
  static BorderRadius borderRadius = BorderRadius.circular(16);
  static final TextStyle ortalamaGosterBody = GoogleFonts.questrial(
      fontSize: 16, fontWeight: FontWeight.w600, color: anaRenk);
  static final TextStyle ortalamaStyle = GoogleFonts.questrial(
